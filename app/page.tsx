          ...
          <div className="max-w-3xl mx-auto text-center">
            <div>
              ...
              <p className="max-w-xl mx-auto mt-8 text-base lg:text-xl text-secondary-foreground">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum perspiciatis ex 
                commodi culpa voluptates? Nemo quas maxime explicabo recusandae
                otam expedita minus corporis natus at labore est dolorem, voluptatibus placeat.
              </p>
