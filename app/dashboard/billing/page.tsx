                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            ...
                            change your payment details and view pour statement at the
                            same time
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
    ...
    <div className="max-w-md mx-auto space-y-4">
        <Card className="flex flex-col">
            <CardContent className="py-8">
                ...
                <p className="mt-5 text-lg text-muted-foreground">Write as many as you want for $30 a month</p>
            </CardContent>
